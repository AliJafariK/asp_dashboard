<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddBan.aspx.cs" Inherits="Vod.AddBan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
    <asp:Button ID="AddBanner" runat="server" Text="Add Banner" OnClick="AddBanner_Click" />
