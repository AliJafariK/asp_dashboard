<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditBundle.aspx.cs" Inherits="Vod.EditBundle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
    <asp:Button ID="AddBundle" runat="server" Text="Update Bundle" OnClick="AddBundle_Click" />
